export const packages = [
  {
    ...
    features: [
      'Dedicated lead coordinator',
      'Final 6-week management',
      'Vendor confirmation & timeline',
      'Rehearsal coordination',
      'On-site day-of management (10 hrs)',
    ],
    featured: false,
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      'Private concierge for VIP guests',
...
export const packagesNote =
  'Every celebration is unique. Each package is a starting point — we tailor a bespoke proposal to your guest count, venue and vision after your complimentary consultation.';
